...
export const siteConfig: SiteConfig = {
	title: "Fqzlr",
	subtitle: "fqzlrの博客",
	siteURL: "https://bk.fqzlr.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-04-20", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "2017273493", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
